  ...
  return (
    <div>
      <div className="bg-gray-50 min-h-screen wrapper">
        {/* Header */}
        <header className="bg-purple-100 py-6">
          <div className="container mx-auto px-4">
            <h1 className="text-2xl font-bold text-left pl-20 text-blue-900">My Account</h1>
            <p className="text-sm text-gray-500 text-left pl-20">

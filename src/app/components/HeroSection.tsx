...
function HeroSection() {
  ...
  return (
    <section className="relative w-full lg:w-max bg-[#F2F0FF] py-10 md:py-20 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden wrapper">
      {/* Left Column: Lamp */}
      ...
      <div className="md:w-1/3 flex justify-center items-center relative">
        <div className="relative bg-gradient-to-r from-pink-100 to-purple-200 rounded-full p-10 shadow-xl md:mt-0 mx-auto">
          <Image
            src={"/sofa1.png"}
            alt="Furniture Chair"
            width={706}
